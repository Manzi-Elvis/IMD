...
export const incidentsApi = {
  list: (filters: IncidentFilters) =>
    apiClient
      .get<PaginatedResult<Incident>>('/incidents', { params: filters })
      .then((r) => r.data),
  ...
  listAttachments: (id: string) =>
    apiClient.get<Attachment[]>(`/incidents/${id}/attachments`).then((r) => r.data),
  ...
  downloadAttachmentUrl: (incidentId: string, attachmentId: string) =>
    `${apiClient.defaults.baseURL}/incidents/${incidentId}/attachments/${attachmentId}/download`,
};
